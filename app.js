...
var config = {
      ...
      "PASS"     : "",
      "HOST"     : "ec2-52-11-254-37.us-west-2.compute.amazonaws.com",  // the domain name of our MongoDB EC2 instance
      "PORT"     : "27017",             // this is the default port mongoDB is listening for incoming queries
      "DATABASE" : "nodeDB"         // the name of your database on that instance
    };
